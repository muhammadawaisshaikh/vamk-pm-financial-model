 ...
 [![Demo Video](https://img.youtube.com/vi/Iq0YmerjQrA/maxresdefault.jpg)](https://youtu.be/Iq0YmerjQrA)

 Watch the short walkthrough above for a demo and explanation of the app: it shows how to edit inputs, view results in the table, and explore the interactive charts.

 Below is a screenshot of the charts view (stored in the `demo/` folder):

 ![Charts screenshot](demo/vamk-project-financial-model.png)
